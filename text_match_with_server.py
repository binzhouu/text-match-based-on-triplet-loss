...
synonyms_path = os.path.join(ROOT_PATH, 'configs/synonyms.yaml')
...
if __name__ == '__main__':
	...
	# texts = ['关闭净化器']
	texts = [
		'关闭电视机', '升高晾衣杆', '升起晾衣杆', '升高晾衣机', '升起晾衣机', '关闭净化器', '打开空净', '扫地机器人回去充电', '打开插线板', '关闭插排', '关闭按摩椅',
		'打开按摩椅子', '开窗', '打开窗', '关闭暖空调', '关闭调光开关', '打开功放', '电灯的亮度调高一点']
	texts = ['打开音响', '打开功放']
